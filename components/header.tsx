...
export const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 border-b border-[#d6b977]/50 bg-black/95 backdrop-blur-md shadow-lg shadow-black/30">
        <div className="w-full">
          <div className="w-full px-0">
            <div className="flex items-center h-16 sm:h-20">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 ml-5 sm:ml-6 lg:ml-8">
                <a
                  href={`tel:${t('header.phone1')}`}
                  className="group h-9 w-9 md:h-10 md:w-10 rounded-lg bg-[#d6b977] transition-all duration-200 hover:bg-[#e4ca88] hover:-translate-y-0.5 flex items-center justify-center"
                ...
                <a
                  ...
                  className="group h-9 w-9 md:h-10 md:w-10 rounded-lg border border-[#d6b977]/40 bg-[#d6b977]/10 text-[#d6b977] transition-all duration-200 hover:border-[#d6b977] hover:bg-[#d6b977]/20 hover:-translate-y-0.5 flex items-center justify-center"
                  aria-label={t('header.whatsappAriaLabel')}
                >
                  <MessageCircle className="w-3.5 h-3.5 md:w-4 md:h-4 group-hover:scale-110 transition-transform duration-200" />
                </a>
                ...
                >
                  <Instagram className="w-3.5 h-3.5 md:w-4 md:h-4 group-hover:scale-110 transition-transform duration-200" />
                </a>
              </div>

              {/* Desktop Navigation and Language Switcher */}
              <div className="hidden lg:flex items-center ml-auto space-x-5 xl:space-x-7 pr-6 sm:pr-8 lg:pr-10">
                  ...
                  {navigationItems.map((item) => (
                    <div key={item.key} className="relative">
                      {item.hasDropdown ? (
                        ...
                        >
                          <button className="px-3 xl:px-4 py-2 font-heading font-semibold text-white/90 hover:text-[#d6b977] hover:bg-[#d6b977]/10 rounded-lg transition-colors duration-200 uppercase text-xs xl:text-sm tracking-wide flex items-center space-x-2">
                            <span>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-3 xl:px-4 py-2 font-heading font-semibold text-white/90 hover:text-[#d6b977] hover:bg-[#d6b977]/10 rounded-lg transition-colors duration-200 uppercase text-xs xl:text-sm tracking-wide"
                        >
                          {t(`navigation.${item.key}`).toUpperCase()}
                        </a>
                      ) : (
