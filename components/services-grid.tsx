...
const ServicesGrid = ({
  ...
  return (
    <div
      className={`grid ${getGridClasses()} gap-6 sm:gap-8 lg:gap-10 ${className}`}
    >
      {services.map((service, index) => {
        ...
        return (
          ...
          >
            {/* Шахматный порядок: чередуем расположение изображения и контента */}
            <div
            ...
            >
              ...
              <div
                className={`relative h-56 sm:h-64 lg:h-80 lg:w-1/2 overflow-hidden ${
              ...
              {/* Content Card */}
              <div
                className={`p-6 sm:p-8 bg-white flex flex-col lg:w-1/2 ${
              ...
              >
                ...
                {/* CTA Buttons */}
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-4 sm:pt-6 space-y-3 sm:space-y-0 sm:space-x-4 mt-auto">
                  <a
                    href={
                      useSpecificLinks
