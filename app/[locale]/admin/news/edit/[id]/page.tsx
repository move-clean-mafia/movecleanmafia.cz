  ...
  useEffect(() => {
    const fetchNewsData = async () => {
      ...
      try {
        ...
        // Set form values
        const publishedAtDate = data.publishedAt?.toDate
        ...
        // Set content for markdown editor
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-lg text-brand-text">
                {newsData?.title || t('admin.news.editDescription')}
              </p>
            </div>
          </div>
              ...
              >
                {isLoading ? (
                  <>
                    ...
                    {t('admin.news.form.updating')}
                  </>
                ) : (
                  <>
                    <Save className="w-4 h-4 mr-2" />
                    {t('admin.news.form.updateArticle')}
                  </>
                )}
              </Button>
            </div>
