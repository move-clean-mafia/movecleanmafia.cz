                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <a
                          ...
                          className="group flex flex-col items-center justify-center p-3 bg-[#d6b977]/10 hover:bg-[#d6b977]/20 text-white font-bold rounded-lg transition-all duration-300 hover:-translate-y-0.5 border border-[#d6b977]/50 hover:border-[#d6b977]"
                        >
                          <div className="w-7 h-7 bg-[#d6b977] text-black rounded-full flex items-center justify-center mb-1.5 transition-all duration-300">
                            <MessageCircle className="w-4 h-4" />
                          </div>
                          <span className="text-xs font-heading">
                            {t('contact.socialMedia.whatsapp')}
                          </span>
                          <span className="text-xs text-white/70 mt-0.5 font-body group-hover:text-white transition-colors duration-300">
