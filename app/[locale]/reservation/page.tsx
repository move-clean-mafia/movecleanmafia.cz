...
import { Calendar, Crown, ArrowRight, CreditCard } from 'lucide-react';
...
export async function generateMetadata({
  ...
  switch (locale) {
    case 'cs':
      ...
      description =
        'Rezervujte si naše profesionální služby stěhování a úklidu v Praze online. Rychlé rezervace, transparentní ceny a garance kvality.';
      break;
    case 'ua':
  ...
  return {
    ...
    openGraph: {
      ...
      title,
      description,
      url: `https://movecleanmafia.cz/${locale}/reservation`,
      ...
      images: [
        ...
        },
        {
          ...
          width: 1920,
          height: 1080,
          alt: 'Book MoveCleanMafia Services - Professional Moving and Cleaning',
          type: 'image/jpeg',
        },
      ],
    ...
    alternates: {
      canonical: `https://movecleanmafia.cz/${locale}/reservation`,
      languages: {
        cs: 'https://movecleanmafia.cz/cs/reservation',
        en: 'https://movecleanmafia.cz/en/reservation',
        uk: 'https://movecleanmafia.cz/ua/reservation',
      },
    },
    robots: {
      index: true,
          ...
          <div className="mt-12 text-center">
            <div className="mafia-card border border-[#d6b977]/30 p-8 hover:border-[#d6b977]/50 transition-colors duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#d6b977] mb-4 font-heading">
                {t('reservation.paymentInfo.title')}
              </h3>
              <p className="text-lg text-white/80 font-body max-w-2xl mx-auto">
                {t('reservation.paymentInfo.description')}
              </p>
            </div>
          </div>
        </div>
